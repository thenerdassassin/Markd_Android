...
import com.markd.applications.android.home.firebase_cloud_messaging.MarkdFirebaseInstanceIDService;

/**
 * Created by Josh Schmidt on 10/7/17.
 */
...
public class FirebaseAuthentication {
    ...
    public void signOut() {
        ...
        (new TempContractorData("", null)).clearContractorData();
        currentUser = null;
    }
}
